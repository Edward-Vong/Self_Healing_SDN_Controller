...
DURATION="${DEMO_DURATION:-45}"
ATTACK_LENGTH="${DEMO_ATTACK_LENGTH:-20}"
RATE="${DEMO_RATE:-4000}"
SIZE="${DEMO_SIZE:-256}"
THRESHOLD="${DEMO_THRESHOLD:-300}"
ATTACK_METHOD="${DEMO_ATTACK_METHOD:-scapy}"
RATE_TOLERANCE="${DEMO_RATE_TOLERANCE:-0.95}"
HOLD_DURATION="${DEMO_HOLD_DURATION:-5}"
REACH_TIMEOUT="${DEMO_REACH_TIMEOUT:-15}"
